    ...
    for i, row_data in enumerate(data):
        for j, cell_data in enumerate(row_data):
            ...
            if i == 0:
                ...
                # Normale Zeilen: Text links, Zahlen mittig
                for paragraph in cell.paragraphs:
...
style_table(6, 4, [
    ['Position', 'Kapitel/Titel', 'Ausgaben in EUR', 'Einnahmen in EUR'],
...
style_h1("Entscheidungsvorschlag")
...
print("Fertig: WU mit vollständigen Style-Richtlinien erstellt")
